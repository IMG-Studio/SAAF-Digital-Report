...
<head>
  ...
  <link rel="apple-touch-icon" sizes="57x57" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/apple-touch-icon-57x57.png">
  <link rel="apple-touch-icon" sizes="60x60" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/apple-touch-icon-60x60.png">
  <link rel="apple-touch-icon" sizes="72x72" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/apple-touch-icon-76x76.png">
  <link rel="apple-touch-icon" sizes="114x114" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/apple-touch-icon-114x114.png">
  <link rel="apple-touch-icon" sizes="120x120" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/apple-touch-icon-120x120.png">
  <link rel="apple-touch-icon" sizes="144x144" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/apple-touch-icon-144x144.png">
  <link rel="apple-touch-icon" sizes="152x152" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/apple-touch-icon-152x152.png">
  <link rel="apple-touch-icon" sizes="180x180" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/apple-touch-icon-180x180.png">
  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
  <meta name="apple-mobile-web-app-title" content="ds-webpack-starter">
  <link rel="icon" type="image/png" sizes="228x228" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/coast-228x228.png">
  <meta name="mobile-web-app-capable" content="yes">
  <meta name="theme-color" content="#fff">
  <meta name="application-name" content="ds-webpack-starter">
  <link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/favicon-16x16.png">
  <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/favicon/favicon.ico">
  ...
  <meta name="msapplication-TileImage" content="mstile-144x144.png">
  <meta name="msapplication-config" content="browserconfig.xml">
  <link href="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/css/main.css?6c27024468b2af243e6a" rel="stylesheet">
</head>
...
<body class="index-page">
  ...
  <div class="main-wrapper">
      ...
      <div class="header-top__wrapper">
        ...
        <nav class="nav-main">
          <ul class="nav-main__list">
            <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="200">[Be a catalyst.]</a></li>
            <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="700">[Make an impact.]</a></li>
            <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="1765">[Embrace change.]</a></li>
            <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="2565">[Have courage.]</a></li>
    ...
    <div class="header-left-nav">
      [ Be a Catalyst. ] – COVID 19 Response Fund
      Turning Point: Merced Housing
      Turning Point: Bexar County Family Justice Center
      Turning Point: SAMMinistries

      [ Make an Impact. ] – Grantmaking by the Numbers  
      Impact Area: Cultural Vibrancy
      Impact Area: Livable and Resilient Communities
      Impact Area: Youth Success
      Impact Area: Successful Aging
      Turning Point: The Public

      [ Embrace Change. ] – Addressing Equity 
      Turning Point: A Letter from 
      Theodore Guidry II, San Antonio Area Foundation Past Chairman of the Board
      Turning Point: SAAAACF

      [ Have Courage. ] – Scholarships
      Turning Point: A Little Help Goes a Long Way
      Thank You from our Student Scholarrs
      Donor Advised Funds
      Donor and Development Services
  ...
  <button class="button button-arrow-red">
    ...
    <section class="section-2a">
      <div class="section-2a__wrapper">
        <div class="section-2a__foto-wrapper"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/foto-marjie-web.jpg" alt=""></div>
    ...
    <section class="section-3a">
      ...
      <div class="section-3a__close" data-toggle=".section-3, .section-3a">X</div>
    </section>
      ...
      <div class="button-next-slide button-next-slide-section-5" data-toggle=".section-5, .section-5b"><span>bexar county family justice center</span>
        ...
        <section class="section-5a">
          <div class="section-5a__wrapper">
            <div class="section-5a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-5a.jpg"></div>
    ...
    Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
            ...
            <div class="section-5b__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-5b.jpg"></div>
    ...
    <section class="section-8a">
      ...
      <div class="section-8a__close" data-toggle=".section-8, .section-8a">X</div>
    </section>
    ...
    <section class="section-12">
      <div class="section-12__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-12.jpg">
...
The Area Foundation partnered with the <span>Ford Foundation</span> to provide $100,000 to the Guadalupe Cultural Arts Center in appreciation of its 36-year history as a home for San Antonio’s Latino artists and cultural traditions and as a means to strengthen the Guadalupe’s ability to work through and beyond the current crisis.</p>
    ...
    <section class="section-13">
      <div class="section-13__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-13.jpg">
...
In a partnership with <span>Metro Health</span> to address health disparities, the Area Foundation awarded seven organizations grants in the amount of $6,717.86 to support COVID-19 response efforts in communities disproportionately impacted. Over 3,000 individuals received support between the months of December 2020 and March 2021.  Services focused on helping individuals meet their basic needs through food distribution, household and hygiene kits, financial assistance, and accessing healthcare. </p>
    ...
    <section class="section-14">
      <div class="section-14__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-14.jpg">
    ...
    <section class="section-15">
      <div class="section-15__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-15.jpg">
...
and provide much-needed entertainment.
    ...
    <section class="section-18a">
      ...
      <div class="section-18a__close" data-toggle=".section-18, .section-18a">X</div>
    </section>
    ...
    <section class="section-20a">
      <div class="section-20a__maincontent">
        <div class="section-20a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-20a.jpg" alt=""></div>
    ...
    <section class="section-21">
      ...
      <div class="section-21__main-content">
        <div class="section-21__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-21.jpg">
    ...
    <section class="section-22">
      ...
      <div class="section-22__main-content">
        <div class="section-22__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-22.jpg">
    ...
    <div class="section-23a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-23a.jpg"></div>
...
Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
    ...
    <section class="section-26a">
      ...
      <div class="section-26a__close" data-toggle=".section-26, .section-26a">X</div>
    </section>
    <section class="section-27">
      ...
      <div class="section-27__main-content">
        <div class="section-27__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-27.jpg">
    ...
    <section class="section-27a">
      <div class="section-27a__maincontent">
        <div class="section-27a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-27a.jpg" alt=""></div>
    ...
    <section class="section-28">
      ...
      <div class="section-28__main-content">
        <div class="section-28__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-28.jpg">
    ...
    <section class="section-28a">
      <div class="section-28a__maincontent">
        <div class="section-28a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-28a.jpg" alt=""><span class="section-28a__imageshorttext">» Alexes Salazar
Harvey E. Najim Charitable Foundation Scholarship Fund</span></div>
    ...
    <section class="section-29a">
      <div class="section-29a__maincontent">
        <div class="section-29a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/images/section-29a.jpg" alt=""></div>
    ...
    <section class="section-30a">
      <div class="section-30a__main-content">
        <div class="section-30a__close" data-toggle=".section-30a">X</div>
    ...
    <section class="section-30b">
      <div class="section-30b__main-content">
        <div class="section-30b__close" data-toggle=".section-30b">X</div>
    ...
    <section class="section-32a">
      <div class="section-32a__close" data-toggle=".section-32a">X</div>
    ...
    <section class="section-32b">
      <div class="section-32b__close" data-toggle=".section-32b">X</div>
  ...
  <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/page-templates/09022021/js/main.js"></script>
</body>
