window.addEventListener("DOMContentLoaded", event => 
{
	...
	{	
		...
		static setScrollDummyHeight () {
			document.getElementsByClassName("scroll-dummy-overlay")[0].style.height = 
				(window.innerHeight * (1 + (getLastScrollAnimation()._scrollStopOffset / 100))) + "px"; // 1 + adds window height to scrollStopOffset percentage height. scrollStopOffset equally 2000 = 20 window heights or common slide height of (100 vh)
		}
	...
	*/
	...
	new ElementAnimation("section-3__icon", "opacity", 0.0, 1.0, 215, 230);
	...
	new ElementAnimation("section-3__icon", "opacity", 1.0, 0.0, 285, 300);
	new ElementAnimation("section-3__background", "opacity", 1.0, 0.0, 245, 300);
	...
	new ElementAnimation("section-12__image", "margin-left", -60, 0, 1100, 1115);
	new ElementAnimation("section-12__image", "opacity", 0.0, 1.0, 1100, 1115);
	new ElementAnimation("section-12__imageshorttext", "opacity", 0.0, 1.0, 1100, 1170);
	new ElementAnimation("section-12__title", "opacity", 0.0, 1.0, 1115, 1180);
	new ElementAnimation("section-12__title", "margin-left", 50, 0, 1115, 1180);
	new ElementAnimation("section-12__text", "opacity", 0.0, 1.0, 1125, 1190);
	new ElementAnimation("section-12__text", "margin-left", 50, 0, 1125, 1190);
	...
	new ElementAnimation("section-13__image", "margin-left", -60, 0, 1200, 1215);
	new ElementAnimation("section-13__image", "opacity", 0.0, 1.0, 1200, 1215);
	new ElementAnimation("section-13__imageshorttext", "opacity", 0.0, 1.0, 1200, 1270);
	new ElementAnimation("section-13__title", "opacity", 0.0, 1.0, 1215, 1280);
	new ElementAnimation("section-13__title", "margin-left", 50, 0, 1215, 1280);
	new ElementAnimation("section-13__text", "opacity", 0.0, 1.0, 1225, 1290);
	new ElementAnimation("section-13__text", "margin-left", 50, 0, 1225, 1290);
	...
	new ElementAnimation("section-14__image", "margin-left", -60, 0, 1300, 1315);
	new ElementAnimation("section-14__image", "opacity", 0.0, 1.0, 1300, 1315);
	new ElementAnimation("section-14__imageshorttext", "opacity", 0.0, 1.0, 1300, 1370);
	new ElementAnimation("section-14__title", "opacity", 0.0, 1.0, 1315, 1380);
	new ElementAnimation("section-14__title", "margin-left", 50, 0, 1315, 1380);
	new ElementAnimation("section-14__text", "opacity", 0.0, 1.0, 1325, 1390);
	new ElementAnimation("section-14__text", "margin-left", 50, 0, 1325, 1390);
	...
	new ElementAnimation("section-15__image", "margin-left", -60, 0, 1400, 1415);
	...
	new ElementAnimation("section-15__title", "opacity", 0.0, 1.0, 1415, 1480);
	new ElementAnimation("section-15__title", "margin-left", 50, 0, 1415, 1480);
	new ElementAnimation("section-15__text", "opacity", 0.0, 1.0, 1425, 1490);
	new ElementAnimation("section-15__text", "margin-left", 50, 0, 1425, 1490);
	...
	window.addEventListener('scroll', function(e) {
		...
		scrollElementAnimations(pageScrollPosition);
