window.addEventListener("DOMContentLoaded", event => 
{
	...
	*/
	...
	new ElementAnimation("section-4__pretitle", "opacity", 0.0, 1.0, 270, 315);
	new ElementAnimation("section-4__title", "opacity", 0.0, 1.0, 300, 315);
	new ElementAnimation("section-4__text", "opacity", 0.0, 1.0, 300, 340);
	
	new ElementAnimation("section-4__pretitle", "margin-left", 100, 0, 250, 385);
	...
	new ElementAnimation("section-10__bar bar-7", "opacity", 0.0, 1.0, 900, 910, function(thisele, sp, ssta, ssto) { updateBarCallback(7, sp, ssta, ssto); });

	new ElementAnimation("section-10__bar bar-6", "opacity", 0.0, 1.0, 910, 920, function(thisele, sp, ssta, ssto) { updateBarCallback(6, sp, ssta, ssto); });

	new ElementAnimation("section-10__bar bar-5", "opacity", 0.0, 1.0, 920, 930, function(thisele, sp, ssta, ssto) { updateBarCallback(5, sp, ssta, ssto); });

	new ElementAnimation("section-10__bar bar-4", "opacity", 0.0, 1.0, 930, 940, function(thisele, sp, ssta, ssto) { updateBarCallback(4, sp, ssta, ssto); });
	
	new ElementAnimation("section-10__bar bar-3", "opacity", 0.0, 1.0, 940, 950, function(thisele, sp, ssta, ssto) { updateBarCallback(3, sp, ssta, ssto); });
	
	new ElementAnimation("section-10__bar bar-2", "opacity", 0.0, 1.0, 950, 960, function(thisele, sp, ssta, ssto) { updateBarCallback(2, sp, ssta, ssto); });

	new ElementAnimation("section-10__bar bar-1", "opacity", 0.0, 1.0, 960, 970, function(thisele, sp, ssta, ssto) { updateBarCallback(1, sp, ssta, ssto); });
	...
	new ElementAnimation("section-21__main-content__image", "scale", 0.975, 1.0, 2015, 2065);
	...
	new ElementAnimation("section-28__title", "opacity", 0.0, 1.0, 2705, 2800);
	new ElementAnimation("section-28__title", "margin-left", 50, 0, 2705, 2800);
	new ElementAnimation("section-28__main-content", "opacity", 0.0, 1.0, 2710, 2730);
	...
	new ElementAnimation("section-29__text", "opacity", 0.0, 1.0, 2810, 2815);
		...
		setTimeout(function() {
			...
			scrollTo(document.getElementsByClassName("section-2a__text")[0], 50, 300);
				setTimeout(function() {
					...
					setTimeout(function() {
						document.getElementsByClassName("section-2a__text-overlay")[0].remove();
					}, 300);
