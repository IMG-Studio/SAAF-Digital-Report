...
<head>
  ...
  <link rel="apple-touch-icon" sizes="57x57" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/apple-touch-icon-57x57.png">
  <link rel="apple-touch-icon" sizes="60x60" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/apple-touch-icon-60x60.png">
  <link rel="apple-touch-icon" sizes="72x72" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/apple-touch-icon-76x76.png">
  <link rel="apple-touch-icon" sizes="114x114" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/apple-touch-icon-114x114.png">
  <link rel="apple-touch-icon" sizes="120x120" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/apple-touch-icon-120x120.png">
  <link rel="apple-touch-icon" sizes="144x144" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/apple-touch-icon-144x144.png">
  <link rel="apple-touch-icon" sizes="152x152" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/apple-touch-icon-152x152.png">
  <link rel="apple-touch-icon" sizes="180x180" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/apple-touch-icon-180x180.png">
  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
  <meta name="apple-mobile-web-app-title" content="ds-webpack-starter">
  <link rel="icon" type="image/png" sizes="228x228" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/coast-228x228.png">
  <meta name="mobile-web-app-capable" content="yes">
  <meta name="theme-color" content="#fff">
  <meta name="application-name" content="ds-webpack-starter">
  <link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/favicon-16x16.png">
  <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/favicon/favicon.ico">
  ...
  <meta name="msapplication-TileImage" content="mstile-144x144.png">
  <meta name="msapplication-config" content="browserconfig.xml">
  <link href="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/css/main.css?6c27024468b2af243e6a" rel="stylesheet">
</head>
  ...
  <button class="button button-arrow-red">
    ...
    <section class="section-2a">
      <div class="section-2a__wrapper">
        <div class="section-2a__foto-wrapper"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/images/foto-marjie-web.jpg" alt=""></div>
    ...
    <section class="section-5a">
      <div class="section-5a__wrapper">
        <div class="section-5a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/images/section-5a.jpg"></div>
...
Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
        ...
        <div class="section-5b__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/images/section-5b.jpg"></div>
...
In a partnership with <span>Metro Health</span> to address health disparities, the Area Foundation awarded seven organizations grants in the amount of $6,717.86 to support COVID-19 response efforts in communities disproportionately impacted. Over 3,000 individuals received support between the months of December 2020 and March 2021.  Services focused on helping individuals meet their basic needs through food distribution, household and hygiene kits, financial assistance, and accessing healthcare. </p>
    ...
    <section class="section-15">
      ...
      <div class="section-14__text-wrapper">
        ...
        <div class="section-15__title">overwhelming to do so.</div>
...
and provide much-needed entertainment.
    ...
    <section class="section-20a">
      <div class="section-20a__maincontent">
        <div class="section-20a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/images/section-20a.jpg" alt=""></div>
  ...
  The six-month nonprofit leadership program is focused on strengthening relationships from diverse communities of color. Applicants may be executive directors or senior program staff at their sponsoring organization. San Antonio Equity Fellowship Program will result in strengthened leadership for community impact, increased cross-cultural understanding, bolstered community collaboration to address pressing social issues, and a network of diverse leaders who will be able to call upon each other in the future.</p>
    ...
    <div class="section-23a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/images/section-23a.jpg"></div>
...
Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
    ...
    <section class="section-27a">
      <div class="section-27a__maincontent">
        <div class="section-27a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/images/section-27a.jpg" alt=""></div>
    ...
    <section class="section-28a">
      <div class="section-28a__maincontent">
        <div class="section-28a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/images/section-28a.jpg" alt=""><span class="section-28a__imageshorttext">» Alexes Salazar
Harvey E. Najim Charitable Foundation Scholarship Fund</span></div>
    ...
    <section class="section-29a">
      <div class="section-29a__maincontent">
        <div class="section-29a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/images/section-29a.jpg" alt=""></div>
...
DAF grantmaking grew 33% in the first and second quarters of 2020 compared to the same time in 2019, with 95% of all giving in response to COVID-19 staying in Bexar County. This sharp increase is directly attributable to independent donors’ urgent concern for nonprofits working on the front lines of the crisis.
  ...
  <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/page-templates/09012021/js/main.js"></script>
</body>
