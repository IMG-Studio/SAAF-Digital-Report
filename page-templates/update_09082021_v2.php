...
<!--  <link rel="icon" type="image/png" sizes="16x16" href="--><?php //echo get_template_directory_uri(); ?><!--/page-templates/09082021_v2/favicon/favicon-16x16.png">-->
  ...
  <meta name="msapplication-TileImage" content="mstile-144x144.png">
  <meta name="msapplication-config" content="browserconfig.xml">
  <link href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/css/main.css?6c27024468b2af243e6a" rel="stylesheet">
</head>
  ...
  <button class="button button-arrow-red">
    ...
    <section class="section-2a">
      <div class="section-2a__wrapper">
        <div class="section-2a__foto-wrapper"><img class="section-2a__foto-wrapper__img" src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/images/foto-marjie-web.jpg" alt=""><img class="section-2a__foto-wrapper__marjie-signature" src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/images/marjie-signature-web.png" alt=""></div>
        <div class="section-2a__text-wrapper">
         ...
         <div class="section-2a__text-overlay"></div>
          <div class="section-2a__text">
            ...
            <img class="section-2a__text__marjie-signature" src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/images/marjie-signature-web-gray.png" alt="">
            <br><br><br>
          </div>
      ...
      <div class="button-next-slide button-next-slide-section-5" data-toggle=".section-5, .section-5b"><span>bexar county family justice center</span>
        ...
        <section class="section-5a">
          <div class="section-5a__wrapper">
            <div class="section-5a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/images/section-5a.jpg"></div>
...
and provide much-needed entertainment.
    ...
    <section class="section-20a">
      <div class="section-20a__maincontent">
        <div class="section-20a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/images/section-20a.jpg" alt=""></div>
    ...
    <section class="section-21">
      ...
      <div class="section-21__main-content">
        <div class="section-21__main-content-wrapper">
          <img class="section-21__main-content__image" src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/images/section-21.jpg">
    ...
    <div class="section-23a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/images/section-23a.jpg"></div>
...
Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
    ...
    <section class="section-27a">
      <div class="section-27a__maincontent">
        <div class="section-27a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/images/section-27a.jpg" alt=""></div>
    ...
    <section class="section-28a">
      <div class="section-28a__maincontent">
        <div class="section-28a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/images/section-28a.jpg" alt=""><span class="section-28a__imageshorttext">» Alexes Salazar
Harvey E. Najim Charitable Foundation Scholarship Fund</span></div>
    ...
    <section class="section-29a">
      <div class="section-29a__maincontent">
        <div class="section-29a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/images/section-29a.jpg" alt=""></div>
  ...
  <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021_v2/js/main.js"></script>
</body>
