window.addEventListener("DOMContentLoaded", event => 
{
	...
	class ElementAnimation {
		...
		animate (scrollPosition) {
			...
			this.animationValue = this.propertyStart + ((this.propertyStop - this.propertyStart) * this.animationPercentage);
	...
	*/
	...
	// Init page element animations
	new ElementAnimation("section-1", "opacity", 100, 200, 1.0, 0.0);
	new ElementAnimation("section-1", "opacity", 400, 500, 0.0, 1.0);
	new ElementAnimation("section-1", "opacity", 700, 800, 1.0, 0.0);

	new ElementAnimation("header-top", "opacity", 35, 85, 1.0, 0.0, true);

	new ElementAnimation("header-left", "opacity", 85, 100, 0.0, 1.0);
	new ElementAnimation("header-left", "position", 85, 100, [-100,0], [0,0]);

	console.log(ElementAnimation.createdAnimations);

	// Init scroll dummy page element dependent on element animations
	document.getElementsByClassName("scroll-dummy-overlay")[0].style.height = 
		( window.innerHeight * (lastAnimationElement().scrollStop / 100)) + "px";

	// !!! todo !!! in scroll console .log compair dummy height to scroll pos 
	                ...
	                if (ElementAnimation.createdAnimations[elementIdentifier].hasOwnProperty(property)) {
	                	...
	                	for (elementPropertyIndex = 0; elementPropertyIndex < elementPropertyCount; elementPropertyIndex++) {
	                		elementAnimationObject = ElementAnimation.createdAnimations[elementIdentifier][property][elementPropertyIndex];
	 						...
	 						if (scrollPosition > elementAnimationObject.scrollStop) {
	 							completedAnimationObject = elementAnimationObject;
	 						}
	 						// range start - stop
	 						else if (scrollPosition >= elementAnimationObject.scrollStart) {
	 							activeAnimationObject = elementAnimationObject;
	 							break;
	 						}
	                    }

	                    if (activeAnimationObject == undefined && completedAnimationObject == undefined) {
	                    	firstAnimationObject = ElementAnimation.createdAnimations[elementIdentifier][property][0];
	                    	firstAnimationObject.update(firstAnimationObject.scrollStart);
	                    }
	                    else if (activeAnimationObject != undefined) {
	                    	activeAnimationObject.update(scrollPosition);
	                    }
	                    else if (completedAnimationObject != undefined) {
	                    	completedAnimationObject.update(completedAnimationObject.update(completedAnimationObject.scrollStop));
	                    }
	                }
	            }
	        }
...
*/
	...
	document.getElementsByClassName("button-prev-slide-section-5")[0].addEventListener('click', function() {
		// document.getElementsByClassName("section-2")[0].classList.add("ceo-clicked");
		document.getElementsByClassName("section-5a")[0].classList.add("merced-clicked");
	});

	document.getElementsByClassName("button-back-slide-section-5a")[0].addEventListener('click', function() {
		// document.getElementsByClassName("section-2")[0].classList.add("ceo-clicked");
		document.getElementsByClassName("section-5a")[0].classList.remove("merced-clicked");
	});

	document.getElementsByClassName("button-next-slide-section-5")[0].addEventListener('click', function() {
		// document.getElementsByClassName("section-2")[0].classList.add("ceo-clicked");
		document.getElementsByClassName("section-5b")[0].classList.add("bexar-clicked");
	});

	document.getElementsByClassName("button-back-slide-section-5b")[0].addEventListener('click', function() {
		// document.getElementsByClassName("section-2")[0].classList.add("ceo-clicked");
		document.getElementsByClassName("section-5b")[0].classList.remove("bexar-clicked");
	});
	...
	document.getElementsByClassName("section-8__icon")[0].addEventListener('click', function() {
		...
		document.getElementsByClassName("section-8a")[0].classList.add("whiterose-clicked");
	});

	document.getElementsByClassName("section-8a__close")[0].addEventListener('click', function() {
		document.getElementsByClassName("section-8")[0].classList.remove("whiterose-clicked");
		document.getElementsByClassName("section-8a")[0].classList.remove("whiterose-clicked");
	});
