 ...
 * Template Name: update09072021_v2
...
<head>
  ...
  <link rel="apple-touch-icon" sizes="57x57" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/apple-touch-icon-57x57.png">
  <link rel="apple-touch-icon" sizes="60x60" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/apple-touch-icon-60x60.png">
  <link rel="apple-touch-icon" sizes="72x72" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/apple-touch-icon-76x76.png">
  <link rel="apple-touch-icon" sizes="114x114" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/apple-touch-icon-114x114.png">
  <link rel="apple-touch-icon" sizes="120x120" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/apple-touch-icon-120x120.png">
  <link rel="apple-touch-icon" sizes="144x144" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/apple-touch-icon-144x144.png">
  <link rel="apple-touch-icon" sizes="152x152" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/apple-touch-icon-152x152.png">
  <link rel="apple-touch-icon" sizes="180x180" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/apple-touch-icon-180x180.png">
  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
  <meta name="apple-mobile-web-app-title" content="ds-webpack-starter">
  <link rel="icon" type="image/png" sizes="228x228" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/coast-228x228.png">
  <meta name="mobile-web-app-capable" content="yes">
  <meta name="theme-color" content="#fff">
  <meta name="application-name" content="ds-webpack-starter">
  <link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/favicon-16x16.png">
  <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/favicon/favicon.ico">
  ...
  <meta name="msapplication-TileImage" content="mstile-144x144.png">
  <meta name="msapplication-config" content="browserconfig.xml">
  <link href="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/css/main.css?6c27024468b2af243e6a" rel="stylesheet">
</head>

<body class="index-page">
  <div class="scroll-dummy-overlay"></div>
  <div class="svg-sprive"><svg width="0" height="0">
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 32" id="icon-screen-down" fill="none" stroke="#85261e"
        stroke-width="3">
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12.307 17.015" id="icon-close-white" stroke-width="0">
        <path d="M129.841,272.655l4.432-5.162,1.017-1.628-2.747-1.717-1.017,1.628-2.388,5.532-2.389-5.532-1.017-1.628-2.747,1.717L124,267.492l4.433,5.162L124,277.817l-1.017,1.628,2.747,1.717,1.017-1.628L129.138,274l2.388,5.532,1.017,1.628,2.747-1.717-1.017-1.628Z" transform="translate(-122.984 -264.147)" />
      </symbol>
  ...
  <div class="main-wrapper">
      ...
      <div class="header-top__wrapper">
        ...
        <nav class="nav-main">
          <ul class="nav-main__list">
            <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="320">[Be a catalyst.]</a></li>
            <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="1050">[Make an impact.]</a></li>
            <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="2590">[Embrace change.]</a></li>
            <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="3800">[Have courage.]</a></li>
    ...
    <div class="header-left-nav">
      ...
      <br><br>
      <span data-offset="1050">[ Make an Impact. ] – Grantmaking by the Numbers</span><br>
      ...
      <br><br>
      <span data-offset="2590">[ Embrace Change. ] – Addressing Equity</span><br>
      ...
      <br><br>
      <span data-offset="3800">[ Have Courage. ] – Scholarships</span><br>
    ...
    <section class="section-2">
      <div class="section-2__text">
        ...
        <div class="section-2__text-4">The choices you make the turns you take, can have a lifelong effect on you and
          those around you. And at the end of the path, you just might find that the obstacle has become an opportunity.</div>
      </div>
  ...
  <button class="button button-arrow-red">
    ...
    <section class="section-2a">
      <div class="section-2a__wrapper">
        <div class="section-2a__foto-wrapper"><img class="section-2a__foto-wrapper__img" src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/foto-marjie-web.jpg" alt=""><img class="section-2a__foto-wrapper__marjie-signature" src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/marjie-signature-web.png" alt=""></div>
        <div class="section-2a__text-wrapper">
         ...
         <div class="section-2a__text-overlay"></div>
          <div class="section-2a__text">
            ...
            <img class="section-2a__text__marjie-signature" src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/marjie-signature-web-gray.png" alt="">
            <br><br><br>
          </div>
          <div class="section-2a__text-shadow-after"></div>
        </div>
        <div class="section-2a__quoter">
          <div class="quote active"><p>&#8220;There is very little that the…Foundation does that doesn’t influence most of our lives…and certainly mine.&#8221;</p><span>&mdash; Mary Rose Brown, Executive Vice President and Chief
            Administrative Officer at NuStar Energy, who served on the COVID-19 Response Fund advisory committee.</span></div>
          <div class="quote"><p>&#8220;I have volunteered in the nonprofit space for more than three decades, and I have never seen such an
            efficient operation.&#8221;</p><span>&mdash; Aaronetta Pierce</span></div>
          <div class="quote"><p>&#8220;You don’t have to be a millionaire to make an investment in a fund. Instead, it’s the kind of person who believes in the community and be able to want to assist others.&#8221;</p><span>&mdash; Janie Barrera</span></div>
        </div>
      </div>
    ...
    <section class="section-5">
      ...
      <div class="button-prev-slide button-prev-slide-section-5" data-toggle=".section-5, .section-5a"> <!--  data-toggle-unique-class="clicked-button-ripple-section-5l" -->
        <button class="button button-arrow-red">
        ...
        </button><span>merced housing texas</span>
      </div>
      <div class="button-next-slide button-next-slide-section-5" data-toggle=".section-5, .section-5b"><span>bexar county family justice center</span>
        ...
        <section class="section-5a">
          <div class="section-5a__wrapper">
            <div class="section-5a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-5a.jpg"></div>
            <div class="section-5a__purplebox">One gift card recipient was a single parent who lost her job due to COVID-19. She is raising her 10-year-old son and was concerned about their limited food supply and having to wait 12 days for their SNAP benefits. When she learned she would be receiving a gift card, she was so appreciative and thanked the Resident Services Coordinator and the agencies involved with helping her family. She stated that with the gift card she would be able to purchase much needed groceries.</div>
            ...
            <div class="section-5a__text">
              ...
              <br>
              <p>The foundation of our health and safety is a decent place to live. When the COVID-19 crisis pushed many in our community to the brink of homelessness, <span>Merced Housing Texas</span>, which focuses on advocating for and providing affordable housing opportunities, was there to help. And the COVID-19 Fund was there to help Merced by providing a $50,000 grant. Kristin Davila, Merced’s President and Executive Director, reports that the agency used half of the grant to cover its Resident Services Program for April. The other half came in the form of $250 gift cards for residents living at one of the agency’s apartment campuses.</p>
            </div>
            <div class="button-back-slide-section-5a" data-toggle=".section-5, .section-5a"> <!--  data-toggle-unique-class="clicked-button-ripple-section-5l" -->
              <button class="button button-arrow-red">
    ...
    Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
            ...
            <div class="section-5b__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-5b.jpg"></div>
    ...
    <section class="section-8">
      ...
      <div class="section-8__text-wrapper">
        <div class="section-8__title"><span class="section-8__title-1">[ Make an </span>impact<span class="section-8__title-2">. ]</span></div>
        <div class="section-8__subtitle"><div class="section-8__subtitle-wrapper">Grantmaking by the Numbers</div></div>
      </div>
      <div class="section-8__icon" data-toggle=".section-8, .section-8a"><span class="section-8__icon__asterisk">*</span> <span class="section-8__icon__read-poem">Read Poem</span></div>
    </section>
    ...
    <section class="section-9">
      ...
      <div class="section-9__stats">
        ...
        <div class="section-9__stats-block"><span>$71.9</span> Million Total Grantmaking</div>
          ...
          <div class="section-9__stats-block section-9__stats-subblock">—<span>$1.1</span> Million in hardship grants</div>
    ...
    <section class="section-10">
      ...
      <div class="section-10__total"><div class="section-10__total-wrapper">$XX,XXX,XXX</div></div>
      <div class="section-10__bars">
        <div class="section-10__bar bar-1"><div class="section-10__bar-inner"><span class="section-10__bar-title">Annual Responsive<br>Grantmaking</span><span class="section-10__bar-total">$3,199,110</span></div></div>
          <div class="section-10__bar bar-2"><div class="section-10__bar-inner"><span class="section-10__bar-title">Designated</span><span class="section-10__bar-total">$3,922,681</span></div></div>
          <div class="section-10__bar bar-3"><div class="section-10__bar-inner"><span class="section-10__bar-title">Scholarships</span><span class="section-10__bar-total">$4,655,491</span></div></div>
          <div class="section-10__bar bar-4"><div class="section-10__bar-inner"><span class="section-10__bar-title">Supporting Organizations</span><span class="section-10__bar-total">$5,168,063</span></div></div>
          <div class="section-10__bar bar-5"><div class="section-10__bar-inner"><span class="section-10__bar-title">Other Grants including all<br>hardship and disaster relief grants</span><span class="section-10__bar-total">$6,156,827</span></div></div>
          <div class="section-10__bar bar-6"><div class="section-10__bar-inner"><span class="section-10__bar-title">COVID-19 Relief Fund</span><span class="section-10__bar-total">$6,490,115</span></div></div>
          <div class="section-10__bar bar-7"><div class="section-10__bar-inner"><span class="section-10__bar-title">Donor Advised Funds (DAFs)<br>Direct Giving to Nonprofits</span><span class="section-10__bar-total">$42,309,054</span></div></div>
      </div>
    </section>
    <section class="section-11">
      ...
      <div class="section-11__wrapper">
        ...
        <div class="section-11__text">
          We are proud to have been the bridge between those most able to give and those who most needed to receive. With community input, research and strategic planning, the San Antonio Area Foundation focused grantmaking and relief efforts on <span>four Impact Areas.</span>
        </div>
    ...
    <section class="section-12a">
      <div class="section-12a__text">
        ...
        <br>
        <br>
        <p>The <span>H. E. Butt Foundation</span> co-invested with the SAAFdn in early-stage capacity building for three organizations: American Indians in Texas at the Spanish Colonial Missions, San Anto Cultural Arts and the Classical Music Institute.
The Area Foundation partnered with the <span>Ford Foundation</span> to provide $100,000 to the Guadalupe Cultural Arts Center in appreciation of its 36-year history as a home for San Antonio’s Latino artists and cultural traditions and as a means to strengthen the Guadalupe’s ability to work through and beyond the current crisis.</p>
      </div>
    ...
    <section class="section-13">
      <div class="section-13__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-13.jpg">
      ...
      <div class="section-12__text-wrapper">
        ...
        <div class="section-13__text">
          ...
          <br>
          <br>
          <p>The 2019 COSA Poverty Report put numbers to the high economic inequality, racial disparities, and residential segregation that continue to plague our city. The 2020 pandemic put faces and, too often, tragic outcomes to those numbers. As philanthropic leaders, we have taken a hard look at what it takes to build a thriving, connected, and resilient San Antonio where residents in every zip code can enjoy the best quality of life that our city offers.</p>
        </div>
      </div>
    ...
    <section class="section-13a">
      <div class="section-13a__text">
        ...
        <br>
        <p>
          Recognizing the challenges rooted in inequitable systems, and identifying the need to uplift the affordable housing and community development sector, the San Antonio Area Foundation partnered with <span>LISC San Antonio</span> to engage nonprofit executives in a pilot leadership development program supporting new and emerging leaders in the affordable housing arena. “Leading to Change: Building Equity in Community”, includes leadership training, racial equity and organizational culture skill-building, and executive coaching.
        </p>
        <br/>
        <p>
          In a partnership with <span>Metro Health</span> to address health disparities, the Area Foundation awarded seven organizations grants in the amount of $6,717.86 to support COVID-19 response efforts in communities disproportionately impacted. Over 3,000 individuals received support between the months of December 2020 and March 2021.  Services focused on helping individuals meet their basic needs through food distribution, household and hygiene kits, financial assistance, and accessing healthcare. 
        </p>
      </div>
    ...
    <section class="section-14">
      <div class="section-14__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-14.jpg">
      ...
      <div class="section-14__text-wrapper">
        ...
        <div class="section-14__text">
          ...
          <br>
          <br>
          <p>The strength of our community lies in the success of our children. The COVID-19 pandemic, however, exposed the lingering inequities in our education system. In response, the San Antonio Area Foundation has invested in organizations who take on the challenge of giving every child an accessible pathway, from cradle to career, to achieve lifelong academic and personal success.</p>
        </div>
      </div>
    ...
    <section class="section-14a">
      <div class="section-14a__text-wrapper">
        <div class="section-14a__text">
          ...
          <br>
          <br>
          <p>The Area Foundation with <span>UP Partnership</span> secured an $8 million commitment from Blue Meridian Partners to expand educational and economic opportunities grounded in equity and data-driven approaches. The project will provide support to youth development agencies, workforce programs, childcare, and leadership development programs that amplify our youth’s voice in the community.</p>
          <br>
          <p>The Area Foundation is involved in a city-wide effort to improve youth outcomes through out-of-school time programs. The initiative, known as <span>Excel Beyond the Bell - San Antonio</span>,  convened 48 nonprofit organizations serving 80,000 area youth centered on building developmental relationships with youth, growing service capacity, and committing to an equitable recovery for all youth impacted by COVID-19.</p>
          <br>
          <p>The Area Foundation and <span>UP Partnership</span> offer organizations the opportunity to rethink many fundamental components of their operations, service delivery, and finances in the wake of the pandemic. <span>RESET*</span> is an organizational recovery framework designed to strengthen the capacity of organizations to navigate challenges. The RESET course launched August 2020 with a focus on organizational recovery, change management, program model improvements, and equity-centered data analysis to drive strategic decisions in uncertain times.</p>
          <br>
          <p>
    ...
    <section class="section-15">
      <div class="section-15__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-15.jpg">
    ...
    <section class="section-15a">
      <div class="section-15a__text-wrapper">
        <div class="section-15a__text">
          ...
          <br>
          <br>
          <p>In 2020, the <span>Successful Aging and Living in San Antonio (SALSA)</span> collective impact initiative built significant momentum. SALSA inspires its 38 multi-sector partners to develop a common agenda and implement agreed upon strategies and activities. Significant accomplishments for SALSA this year include:</p>
          <br>
          <p>• In partnership with <span>WellMed Charitable Foundation</span>, the creation, development, and distribution of the Family Caregiver Toolkit, in Spanish and English, to offer resources to spouses, family, and significant others who provide care for their loved ones.</p>
          <br>
          <p>• Training and launch of our community’s Reframing Aging Initiative.  With training received from <span>The Gerontological Society of America (GSA)</span>, who lead the national reframing aging initiative, SALSA trained and graduated 15 Reframing Aging Facilitators dedicated to using evidence-based, cutting edge communications tools and messages developed by <span>FrameWorks Institute</span>, and tailored for our community.  By changing the way that people talk and think about aging, we are setting the foundation for policies and practices that leverage the strengths and talents of older people, and systems that support well-being for all of us as we age.</p>
          </p>
          <br>
          <p>
            • Co-authoring with <span>City of San Antonio</span> and <span>Disability SA</span> of a survey and report of the experiences of people with disabilities during COVID-19.
          </p>
          <br>
          <p>
...
and provide much-needed entertainment.
    ...
    <section class="section-18">
      ...
      <div class="section-18__text-wrapper">
        <div class="section-18__title"><span class="section-18__title-1">[ </span>Embrace<span class="section-18__title-2"> change. ]</span></div>
        <div class="section-18__subtitle">Addressing Equity</div>
      </div>
      <div class="section-18__icon" data-toggle=".section-18, .section-18a"><span class="section-18__icon__asterisk">*</span> <span class="section-18__icon__read-poem">Read Poem</span></div>
    </section>
    ...
    <section class="section-20a">
      <div class="section-20a__maincontent">
        <div class="section-20a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-20a.jpg" alt=""></div>
    ...
    <section class="section-21">
      ...
      <div class="section-21__main-content">
        <div class="section-21__main-content-wrapper">
          <img class="section-21__main-content__image" src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-21.jpg">
      ...
      <div class="section-21__quoter">
        <p>&#8220;Where you were born, where you live, and the color of your skin, should not determine your life outcomes.&#8221;</p><span>&mdash; Marjie French, CEO</span>
      </div>
    </section>
    <section class="section-22">
      ...
      <div class="section-22__main-content">
        <div class="section-22__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-22.jpg">
          <div class="section-22__text">
            <h3>Meaningful decisions need meaningful data: The State of the African American Community in Bexar County</h3>
            <br>
            <p>
    ...
    <section class="section-23">
      ...
      <div class="section-23__sectors">
        <div class="section-23__sector sector-1">
          ...
          <br>
          <p>We assisted the fund and lead donors Cara and Brian Wright to establish a new charitable fund to provide free legal services for matters involving bail issues, law enforcement excessive use of force, racial discrimination, and voting rights.</p>
        </div>
        <div class="section-23__sector sector-2">
          <h3>Census outreach</h3>
          <br>
          <p>We partnered with data analysis organization CI:NOW and the African American Fund to develop outreach strategies and collateral materials to target African American communities historically underrepresented in the U.S. Census. Additionally, we partnered COSA and Bexar County and five other organizations to ensure a complete count.</p>
        </div>
        <div class="section-23__sector sector-3">
          <h3>emergency and rapid response grants</h3>
          <br>
          <p>The Area Foundation also provided emergency and rapid response grants to multiple nonprofits who were connected with families disproportionately impacted by COVID-19 to continue to provide critical safety net and recovery services in the wake of a crisis.</p>
        </div>
    ...
    <section class="section-23a">
      <div class="section-23a__text-wrapper">
        ...
        <h3>HOW DO YOU BRING ABOUT JUSTICE AND EQUITY WHILE STRENGTHENING BONDS BETWEEN DIVERSE COMMUNITIES OF COLOR?</h3>
        <br>
        <p>
          <span>The San Antonio Equity Fellowship Program</span> is a pilot transformational leadership program focused on bringing together African American and Latinx participants who are committed to constructively altering societal conditions toward fuller justice and equity for all. The San Antonio Area Foundation is pleased to offer this unique opportunity for personal and professional development as part of the Foundation’s commitment to equity work, capacity building of our nonprofit sector, and commitment to strengthen the leaders of nonprofit organizations in San Antonio.
        </p>
        <br>
        <p>
    ...
    <div class="section-23a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-23a.jpg"></div>
...
Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
    ...
    <section class="section-26">
      ...
      <div class="section-26__title"><span class="section-26__title-1">[ Have </span>courage<span class="section-26__title-2">. ]</span></div>
      <div class="section-26__subtitle">Scholarships</div>
      <div class="section-26__icon" data-toggle=".section-26, .section-26a"><span class="section-26__icon__asterisk">*</span> <span class="section-26__icon__read-poem">Read Poem</span></div>
    </section>
    ...
    <section class="section-27">
      ...
      <div class="section-27__main-content">
        <div class="section-27__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-27.jpg">
    ...
    <section class="section-27a">
      <div class="section-27a__maincontent">
        <div class="section-27a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-27a.jpg" alt=""></div>
      ...
      <div class="section-27a__quoter">
        <p>&#8220;Thank you again for the work you do to support future generations of students and thank you again for helping me pursue my dreams.&#8221;</p><span>&mdash; Eric</span>
      </div>
    ...
    <section class="section-28">
      ...
      <div class="section-28__main-content">
        <div class="section-28__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-28.jpg">
          <div class="section-28__text">
            <h3>Donor generosity</h3>
            <br>
            <p>
              Thanks to the generosity of our donors, the Area Foundation awarded <span>$4.6M</span> in support of <span>905 scholarship grants</span> in 2020. The Area Foundation hosts more than 100 scholarship funds available for graduating high school students and current college students. Each fund has its own criteria based on the fund advisor’s interest. Some scholarships fund a specific area of study, a donor’s alma mater, or scholarships to students from a specific school.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="section-28a">
      <div class="section-28a__maincontent">
        <div class="section-28a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-28a.jpg" alt=""><span class="section-28a__imageshorttext">» Alexes Salazar
Harvey E. Najim Charitable Foundation Scholarship Fund</span></div>
    ...
    <section class="section-29a">
      <div class="section-29a__maincontent">
        <div class="section-29a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/images/section-29a.jpg" alt=""></div>
    ...
    <section class="section-30">
      ...
      <div class="section-30__link-1" data-toggle=".section-30a">[ Connecting the dots: donor and development services team ]</div>
    ...
    <section class="section-30a">
      <div class="section-30a__main-content">
        ...
        <div class="section-30a__quoter">
          <p>“The San Antonio Area Foundation’s role is to connect the dots. It’s to be able to see people who have resources and where their wishes are and then connect those wishes of making our world a better place with the right non-profit.”</p><span>—Janie Barrera</span>
        </div>
    ...
    <section class="section-32a">
      ...
      <div class="section-32a__text">
        <p>
          ...
          Harry W. Wolff, Jr.<br>
          <br><br>
          <i>The San Antonio Area Foundation would like to thank outgoing directors for their outstanding service on our board through 2020:</i>
          <br><br>
          Laura Ehrenberg-Chesler<br>
          Luis de la Garza<br>
          Theo Guidry<br>
  ...
  <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/page-templates/09072021_v2/js/main.js"></script>
</body>
