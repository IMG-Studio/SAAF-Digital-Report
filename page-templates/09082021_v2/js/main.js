window.addEventListener("DOMContentLoaded", event => {
    ...
    new ElementAnimation("header-top", "opacity", 1.0, 0.0, 10, 70);

    new ElementAnimation("header-left", "opacity", 0.0, 1.0, 100, 110);
    new ElementAnimation("header-left", "margin-left", -96, 0, 100, 110);


    new ElementAnimation("section-2__text-1", "opacity", 0.0, 1.0, 95, 140);
    new ElementAnimation("section-2__text-1", "margin-left", 50, 0, 95, 130);
    ...
    new ElementAnimation("section-3__subtitle", "opacity", 0.0, 1.0, 195, 205);
    ...
    new ElementAnimation("section-3__icon", "opacity", 1.0, 0.0, 210, 256, function (thisele, sp, ssta, ssto) {
        if (sp >= ssto) {
            thisele.container.style.pointerEvents = "none";
        } else {
            thisele.container.style.pointerEvents = "all";
        }
    });
    new ElementAnimation("section-3__background", "opacity", 1.0, 0.0, 265, 300);
    new ElementAnimation("section-3__title-1", "opacity", 1.0, 0.0, 220, 240);
    new ElementAnimation("section-3__title-2", "opacity", 1.0, 0.0, 220, 240);
    new ElementAnimation("section-3__subtitle", "opacity", 1.0, 0.0, 220, 240);
    ...
    new ElementAnimation("section-8__subtitle-wrapper", "opacity", 0.0, 1.0, 670, 700);
    ...
    new ElementAnimation("section-26__title", "opacity", 0.0, 1.0, 2485, 2545);
    ...
    new ElementAnimation("section-26__title-1", "opacity", 1.0, 0.0, 2550, 2585);
    new ElementAnimation("section-26__title-2", "opacity", 1.0, 0.0, 2550, 2585);
    new ElementAnimation("section-26__subtitle", "opacity", 1.0, 0.0, 2550, 2585);
    ...
    new ElementAnimation("section-27__background", "opacity", 1.0, 0.0, 2685, 2700, function (thisele, sp, ssta, ssto) {
        ...
        if (sp >= ssto) {
            section27.style.pointerEvents = "none";
        } else {
            section27.style.pointerEvents = "all";
        }
    });
    ...
    */
    ...
    function toggleHelper2(query, index) {
        // toggleElements from parameter
        var toggleElements = document.querySelectorAll(query);
        toggleTimeouts[index] = setTimeout(function () {
            console.log(index);
            toggleElements[index].classList.remove("toggled");
        }, 333);
    }
    ...
    function toggleHelper3(query, uniqueClasses, index) {
        ...
        setTimeout(function () {
            ...
            if (uniqueClasses != undefined)
                toggleElements[index].classList.remove(uniqueClasses);
        }, 500);
    }
