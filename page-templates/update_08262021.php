...
<head>
  ...
  <link rel="apple-touch-icon" sizes="57x57" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/apple-touch-icon-57x57.png">
  <link rel="apple-touch-icon" sizes="60x60" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/apple-touch-icon-60x60.png">
  <link rel="apple-touch-icon" sizes="72x72" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/apple-touch-icon-76x76.png">
  <link rel="apple-touch-icon" sizes="114x114" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/apple-touch-icon-114x114.png">
  <link rel="apple-touch-icon" sizes="120x120" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/apple-touch-icon-120x120.png">
  <link rel="apple-touch-icon" sizes="144x144" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/apple-touch-icon-144x144.png">
  <link rel="apple-touch-icon" sizes="152x152" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/apple-touch-icon-152x152.png">
  <link rel="apple-touch-icon" sizes="180x180" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/apple-touch-icon-180x180.png">
  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
  <meta name="apple-mobile-web-app-title" content="ds-webpack-starter">
  <link rel="icon" type="image/png" sizes="228x228" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/coast-228x228.png">
  <meta name="mobile-web-app-capable" content="yes">
  <meta name="theme-color" content="#fff">
  <meta name="application-name" content="ds-webpack-starter">
  <link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/favicon-16x16.png">
  <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/favicon/favicon.ico">
  ...
  <meta name="msapplication-TileImage" content="mstile-144x144.png">
  <meta name="msapplication-config" content="browserconfig.xml">
  <link href="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/css/main.css?6c27024468b2af243e6a" rel="stylesheet">
</head>
  ...
  <div class="main-wrapper">
    ...
    <section class="section-2a fixed">
      <div class="section-2a__wrapper">
        <div class="section-2a__foto-wrapper"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/foto-marjie-web.jpg" alt=""></div>
    ...
    <section class="section-51 fixed">
      <div class="section-51__wrapper">
        <div class="section-51__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/section-51.jpg"></div>
...
Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
        ...
        <div class="section-52__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/section-52.jpg"></div>
...
to kill you. You feel powerless and desperate. The Family Justice Center’s services helped me to have courage. Today I am safe. I have been able to carry on with my beautiful life. I am able to see my people without being terrified. I just want to express my gratitude to all of you because you help me feel safe and protected.”</div>
    ...
    <section class="section-8 fixed">
      ...
      <div class="section-8__subtitle">Grantmaking by the Numbers</div>
    ...
    <section class="section-12 fixed">
      <div class="section-12__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/section-12.jpg">
...
The Area Foundation partnered with the <span>Ford Foundation</span> to provide $100,000 to the Guadalupe Cultural Arts Center in appreciation of its 36-year history as a home for San Antonio’s Latino artists and cultural traditions and as a means to strengthen the Guadalupe’s ability to work through and beyond the current crisis.</p>
    ...
    <section class="section-13 fixed">
      <div class="section-13__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/section-13.jpg">
...
In a partnership with Metro Health to address health disparities, the Area Foundation awarded seven organizations grants in the amount of $6,717.86 to support COVID-19 response efforts in communities disproportionately impacted. Over 3,000 individuals received support between the months of December 2020 and March 2021.  Services focused on helping individuals meet their basic needs through food distribution, household and hygiene kits, financial assistance, and accessing healthcare. </p>
    ...
    <section class="section-14 fixed">
      <div class="section-14__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/section-14.jpg">
    ...
    <section class="section-14a fixed">
      <div class="section-14a__text">
        <h3>Vital partnerships</h3>
        <br>
        <p>The Area Foundation with UP Partnership secured an $8 million commitment from Blue Meridian Partners to expand educational and economic opportunities grounded in equity and data-driven approaches. The project will provide support to youth development agencies, workforce programs, childcare, and leadership development programs that amplify our youth’s voice in the community.
    ...
    * Reflect on the vision guiding your work
       ...
       Transform how your organization learns</p>
      </div>
    ...
    <section class="section-15 fixed">
      <div class="section-15__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/section-15.jpg"></div>
    ...
    <section class="section-15a fixed">
      <div class="section-15a__text">
        <h3>Vital partnerships</h3>
        <br>
        <p>In 2020, the Successful Aging and Living in San Antonio (SALSA) collective impact initiative built significant momentum. SALSA inspires its 38 multi-sector partners to develop a common agenda and implement agreed upon strategies and activities. Significant accomplishments for SALSA this year include:
    ...
    • Co-authoring with City of San Antonio and DisabilitySA of a survey and report of the experiences of people with disabilities during COVID-19.
    • The Innovators in Aging award for unique and successful efforts to serve older Texans (Texas Health and Human Services).</p>
      </div>
...
and provide much-needed entertainment.
    ...
    <section class="section-20a fixed">
      <div class="section-20a__maincontent">
        <div class="section-20a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/section-20a.jpg" alt=""></div>
    ...
    <section class="section-21 fixed">
      ...
      <div class="section-21__main-content">
        <div class="section-21__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/section-21.jpg">
    ...
    <section class="section-22 fixed">
      ...
      <div class="section-22__main-content">
        <div class="section-22__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/section-22.jpg">
...
The six-month nonprofit leadership program is focused on strengthening relationships from diverse communities of color. Applicants may be executive directors or senior program staff at their sponsoring organization. San Antonio Equity Fellowship Program will result in strengthened leadership for community impact, increased cross-cultural understanding, bolstered community collaboration to address pressing social issues, and a network of diverse leaders who will be able to call upon each other in the future.</p>
    ...
    <div class="section-23a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/images/section-23a.jpg"></div>
...
Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
  ...
  <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/page-templates/08262021/js/main-igr.js"></script>
</body>
