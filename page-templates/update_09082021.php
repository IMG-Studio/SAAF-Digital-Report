...
<head>
  ...
  <link rel="apple-touch-icon" sizes="57x57" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/apple-touch-icon-57x57.png">
  <link rel="apple-touch-icon" sizes="60x60" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/apple-touch-icon-60x60.png">
  <link rel="apple-touch-icon" sizes="72x72" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/apple-touch-icon-76x76.png">
  <link rel="apple-touch-icon" sizes="114x114" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/apple-touch-icon-114x114.png">
  <link rel="apple-touch-icon" sizes="120x120" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/apple-touch-icon-120x120.png">
  <link rel="apple-touch-icon" sizes="144x144" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/apple-touch-icon-144x144.png">
  <link rel="apple-touch-icon" sizes="152x152" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/apple-touch-icon-152x152.png">
  <link rel="apple-touch-icon" sizes="180x180" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/apple-touch-icon-180x180.png">
  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
  <meta name="apple-mobile-web-app-title" content="ds-webpack-starter">
  <link rel="icon" type="image/png" sizes="228x228" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/coast-228x228.png">
  <meta name="mobile-web-app-capable" content="yes">
  <meta name="theme-color" content="#fff">
  <meta name="application-name" content="ds-webpack-starter">
  <link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/favicon-16x16.png">
  <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/favicon/favicon.ico">
  ...
  <meta name="msapplication-TileImage" content="mstile-144x144.png">
  <meta name="msapplication-config" content="browserconfig.xml">
  <link href="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/css/main.css?6c27024468b2af243e6a" rel="stylesheet">
</head>
  ...
  <button class="button button-arrow-red">
    ...
    <section class="section-2a">
      <div class="section-2a__wrapper">
        <div class="section-2a__foto-wrapper"><img class="section-2a__foto-wrapper__img" src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/foto-marjie-web.jpg" alt=""><img class="section-2a__foto-wrapper__marjie-signature" src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/marjie-signature-web.png" alt=""></div>
        <div class="section-2a__text-wrapper">
         ...
         <div class="section-2a__text-overlay"></div>
          <div class="section-2a__text">
            ...
            <img class="section-2a__text__marjie-signature" src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/marjie-signature-web-gray.png" alt="">
            <br><br><br>
          </div>
      ...
      <div class="button-next-slide button-next-slide-section-5" data-toggle=".section-5, .section-5b"><span>bexar county family justice center</span>
        ...
        <section class="section-5a">
          <div class="section-5a__wrapper">
            <div class="section-5a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-5a.jpg"></div>
    ...
    Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
            ...
            <div class="section-5b__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-5b.jpg"></div>
    ...
    <section class="section-12">
      <div class="section-12__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-12.jpg">
...
The Area Foundation partnered with the <span>Ford Foundation</span> to provide $100,000 to the Guadalupe Cultural Arts Center in appreciation of its 36-year history as a home for San Antonio’s Latino artists and cultural traditions and as a means to strengthen the Guadalupe’s ability to work through and beyond the current crisis.</p>
    ...
    <section class="section-13">
      <div class="section-13__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-13.jpg">
    ...
    <section class="section-14">
      <div class="section-14__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-14.jpg">
    ...
    <section class="section-15">
      <div class="section-15__image">
        <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-15.jpg">
...
and provide much-needed entertainment.
    ...
    <section class="section-20a">
      <div class="section-20a__maincontent">
        <div class="section-20a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-20a.jpg" alt=""></div>
    ...
    <section class="section-21">
      ...
      <div class="section-21__main-content">
        <div class="section-21__main-content-wrapper">
          <img class="section-21__main-content__image" src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-21.jpg">
    ...
    <section class="section-22">
      ...
      <div class="section-22__main-content">
        <div class="section-22__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-22.jpg">
    ...
    <div class="section-23a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-23a.jpg"></div>
...
Before the pandemic, the Area Foundation had already begun the transition to trust-based philanthropy allowing organizations to focus on their mission and adjust or apply the grant dollars where they were needed most. This pivot to operational funding enabled the Bexar County Family Justice Center to apply the needed funds to provide crisis intervention and support services to a larger-than-normal client base. </p>
    ...
    <section class="section-27">
      ...
      <div class="section-27__title-2">seize an opportunity.</div>
      <div class="section-27__main-content">
        <div class="section-27__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-27.jpg">
    ...
    <section class="section-27a">
      <div class="section-27a__maincontent">
        <div class="section-27a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-27a.jpg" alt=""></div>
    ...
    <section class="section-28">
      ...
      <div class="section-28__main-content">
        <div class="section-28__main-content-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-28.jpg">
    ...
    <section class="section-28a">
      <div class="section-28a__maincontent">
        <div class="section-28a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-28a.jpg" alt=""><span class="section-28a__imageshorttext">» Alexes Salazar
Harvey E. Najim Charitable Foundation Scholarship Fund</span></div>
    ...
    <section class="section-29a">
      <div class="section-29a__maincontent">
        <div class="section-29a__image"><img src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/images/section-29a.jpg" alt=""></div>
  ...
  <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/page-templates/09082021/js/main.js"></script>
</body>
